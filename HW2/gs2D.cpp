...
int main(int argc, char** argv){
	...
	for (iter = 0; iter < max_iter; iter++) {//iterate
		...
		//loop through and solve for u with u
		#ifdef _OPENMP
		...
		//now loop through and calc residual and set u to u
		residual = 0;
		#ifdef _OPENMP
